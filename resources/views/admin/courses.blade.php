          ...
          <div class="card-body">
            ...
            <div class="card ct-card mb-3">
              ...
              <div class="card-header ct-header py-reduced" style="text-transform: none;">
                <small class="info-small text-light">
                  ...
                  &nbsp Select where do you want to bind your courses
                </small>
              </div>
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-md-12 mb-2">
                    <small class="ct-small-font">Program</small>
            ...
            <div class="card ct-card">
              ...
              <div class="card-body">
                ...
                <button type="submit" class="btn btn-danger pull-right" id="addBtn"> Save </button>
...
{{-- IMPORT COURSES FROM EXCEL --}}
    <div class="col-md-5">
            <div class="card ct-card">
              <div class="card-header ct-header py-reduced-1">
                <i class="fa fa-cog" aria-hidden="true"></i>&nbsp<small>Import from excel</small>
      ...
      <div class="modal-content">
          ...
          <div class="modal-header ct-modal-head py-reduced">
              <div class="modal-title">
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> &nbsp<small>Update Course</small>
              </div>

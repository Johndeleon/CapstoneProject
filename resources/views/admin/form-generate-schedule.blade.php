    ...
    <div class="col-md-5">
      ...
      <div class="card ct-card">
        ...
        <div class="card-header ct-header py-reduced-1">
          ...
          <i class="fa fa-cog" style="font-size: 1rem" aria-hidden="true"></i>&nbsp<small>Schedule Settings</small>
        </div>
        ...
        <div class="card-body">
          ...
          <form id="generateScheduleForm">
            ...
            <div class="form-group">
              <small class="ct-small-font">Programs</small>
    ...
    <div class="col-md-7">
      ...
      <div class="card ct-card">
        ...
        <div class="card-header ct-header py-reduced-1">
          ...
          <i class="fa fa-wpforms" aria-hidden="true" style="font-size: 1rem"></i>&nbsp <small>Schedule Form for <span id="selected_program"> *---* </span></small>
        </div>

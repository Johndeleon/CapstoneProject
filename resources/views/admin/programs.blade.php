  ...
  <div class="row">
        ...
        <div class="card-body">
          ...
          <form id="addProgramData">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control tobe-reset required" name="title" placeholder="">
            </div>

            <div class="form-group">
              <small class="ct-small-font"> Program Description (optional)</small>
              <textarea class="form-control tobe-reset required" name="description" placeholder="" title="Add description to the course"></textarea>
            </div>

            <div class="form-group">
              <small class="ct-small-font"> Year Levels </small>
              <input type="text" class="form-control tobe-reset required" maxlength="1" name="level" placeholder="Number of level program level" title="Input how many level this course has">
            </div>
            ...
            <button type="submit" id="addProgram" class="btn btn-danger pull-right pointer">
              Save
            </button>
          </form>
    ...
    <div class="col-md-5">
      <div class="card ct-card">
        ...
        <div class="card-header ct-header py-reduced-1">
          <small>
            <i class="fa fa-file mt-0" aria-hidden="true"></i>
            &nbsp<span style="line-height: 20px">Import from excel</span>
          </small>

      ...
      <div class="card ct-card reload-page">
        ...
        <form id="id-addTeacher">
          ...
          <div id="firstForm" class="card-body">
            ...
            <button id="goAvaiDays" class="btn btn-primary pull-right">Next page &nbsp <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
          ...
          <div id="secondForm" class="card-body">
            ...
            <button id="id-addTeacher-btn" type="submit" class="btn btn-danger pull-right" title="Add this teacher in your database">Save</button>
...
{{-- IMPORT TEACHERS FROM EXCEL --}}
    <div class="col-md-5">
            <div class="card ct-card">
              <div class="card-header ct-header py-reduced-1">
                <i class="fa fa-file" aria-hidden="true" style="font-size: 0.9rem"></i>
              ...
              <form method="POST" action="/admin/teachers/import-teachers" name="import-teachers" enctype="multipart/form-data">
                ...
                {{-- SELECT EXCEL FILE --}}
                  ...
                  <button type="submit" id="importTeachers" class="btn btn-danger pull-right">
                    <i class="fa fa-file" aria-hidden="true"></i> &nbspImport File
                  </button>
              </form>
...
{{-- IMPORT AVAILABLETIME FROM EXCEL --}}
    <div class="col-md-5">
            ...
            <div class="card-body">
              <h6>Teacher Available Time & Day</h6>
              <hr>

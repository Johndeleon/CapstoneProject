  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-files-o"></i> <span>Maintenance</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/admin/programs"><i class="fa fa-circle-o"></i> Programs</a></li>
            <li><a href="/admin/teachers"><i class="fa fa-circle-o"></i> Teachers</a></li>
            <li><a href="/admin/courses"><i class="fa fa-circle-o"></i> Courses</a></li>
            <li><a href="/admin/rooms"><i class="fa fa-circle-o"></i> Rooms</a></li>
          </ul>
        </li>
        ...
        <li>
          <a href="/admin/generate-form-schedules">
            <i class="fa fa-th"></i> <span>Generate Schedule</span>
            <span class="pull-right-container">

...
<head>
    ...
    <link href="{{ asset('css/bootstrap/bootstrap-4.1.3/dist/css/bootstrap.min.css') }}" rel="stylesheet">
...
@yield('head')
    ...
    {{-- SCRIPTS HERE --}}
    {{-- <script type="text/javascript" src="{{ asset('js/jquery/jquery-3.3.1.slim.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/bootstrapjs/bootstrap-4.1.3/dist/js/bootstrap.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/jquery/jquery-3.3.1.slim.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/bootstrapjs/bootstrap.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/plugins/select2/select2.min.js') }}"></script>

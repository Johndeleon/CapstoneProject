...
/* DASHBOARD MODULE */
/** GET empty schedules */
Route::get('/admin/dashboard/get-empty-program', 'HomeController@getEmptySchedule')->name('getEmptySchedule');

Route::get('/admin/dashboard/delete-schedule', 'HomeController@deleteSchedule')->name('deleteSchedule');

Route::post('/admin/dashboard/get-filtered-schedule', 'HomeController@getFilteredSchedule')->name('getFilteredSchedule');

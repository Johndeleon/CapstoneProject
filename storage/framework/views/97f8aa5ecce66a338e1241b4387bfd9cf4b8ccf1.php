...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Courses <button class="item btn  btn-info" data-toggle="modal" data-target="#addCourse">
                                                        Add Course
                                                    </button></div>
                    ...
                    <table class="table-bordered">
                        ...
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="item btn  btn-info" data-toggle="modal" data-target="#editCourse<?php echo e($course->id); ?>">
                                                        Edit
                                                    </button>
                                                    <button class="item btn  btn-danger" data-toggle="modal" data-target="#deleteCourse<?php echo e($course->id); ?>">
                                                        Delete
                                                    </button>
                                    </td>
                                </tr>
            ...
            <form action="addcourse" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">                    
                        ...
                        <tr>
                            <td><input name="total_hours[]" type="number" placeholder="Total Hours" class="form-control" min=2 required></td>
                        </tr>
                        <tr>
                            <td>
